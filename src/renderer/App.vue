          ...
          <ul id="tabs-swipe" class="tabs">
            ...
            <li v-if="options['__pinlast']" class="last-notify x-small">
              ...
              <span>
                [<span
                  @click="
                    pickChannel(notifications[notifications.length - 1].channel)
                  "
                  class="text-white"
                  >#{{ notifications[notifications.length - 1].channel }}</span
                >]&nbsp;
              </span>
              <span
                v-html="
                  parseBadges(
                    notifications[notifications.length - 1].badges,
                    notifications[notifications.length - 1].channel
                  )
                "
                class="parsed-badges"
              ></span>
              <span
                v-html="
                  parseUsername(
                    notifications[notifications.length - 1].username,
              ...
              <span
                v-html="
                  parseMessage(
                    ...
                    notifications[notifications.length - 1].emotes,
                    notifications[notifications.length - 1].channel
                  )
                "
            ...
            <li class="changelog pull-right x-small link">
              <img
                @click="initChangeLog(true)"
                src="data:image/png;base64,"
              />
            </li>
  ...
  methods: {
    ...
    showNotification(title, message) {
      ...
      if (this.options && this.options['__soundalerts']) {
        let audio = new Audio(
          'data:audio/mpeg;base64,'
        )
        audio.volume = 0.3
        audio.play()
      }
